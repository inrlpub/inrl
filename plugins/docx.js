...
let wk = Config.WORKTYPE == 'public' ? false : true
   ...
   fasweeh.addCommand({ pattern: 'ttplist', fromMe: wk, desc: 'ttp maker list'}, (async (message, match) => {
...
`,quoted: message.data})
     ...
     fasweeh.addCommand({ pattern: '01ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(rex.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  Config.AFN + '\n\n   ```Coded by fasweeh``` ',quoted: message.data})

    }));
   
   fasweeh.addCommand({ pattern: '02ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '03ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '04ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '05ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '06ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '07ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '08ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '09ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '10ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '11ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
     ...
     fasweeh.addCommand({ pattern: '12ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '13ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '14ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '15ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '16ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '17ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
    ...
    fasweeh.addCommand({ pattern: '18ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
    ...
    fasweeh.addCommand({ pattern: '19ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
    ...
    fasweeh.addCommand({ pattern: '20ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
    ...
    fasweeh.addCommand({ pattern: '21ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
    ...
    fasweeh.addCommand({ pattern: '22ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '23ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
    ...
    fasweeh.addCommand({ pattern: '24ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '25ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '26ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '27ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '28ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '29ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '30ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '31ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '32ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '33ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '34ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '35ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '36ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '37ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '38ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
      ...
      fasweeh.addCommand({ pattern: '39ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
   ...
   fasweeh.addCommand({ pattern: '40ttp ?(.*)', fromMe: wk,dontAdCommandList: true }, (async (message, match) => {
...
fasweeh.addCommand({pattern: 'wasted ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
fasweeh.addCommand({pattern: 'delete ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
